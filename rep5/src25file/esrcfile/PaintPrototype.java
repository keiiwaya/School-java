...
import java.io.*;          // import package java.io.*
...
public abstract class PaintPrototype implements GPaint {
  ...
  String fileName;                 // the name of the file to store the shapes
  ...
  public boolean init(String fn, Graphics gra) {
    ...
    try{
      ...
      System.out.println("the data of file " + fileName + " have been read");
      return true;
    } catch (FileNotFoundException fe) {
      System.out.println("a new file is created because file" + fileName + " does not exist.");
      shape= new Shape[256];
      return true;
    } catch (IOException ie) {
      System.out.println(ie.getMessage());
      System.out.println("program ends because an IO exception occurred.");
      return false;
    } catch (ClassNotFoundException ce) {
      System.out.println(ce.getMessage());
      System.out.println("program ends because an class exception occurred.");
      return false;
    }
  }
  ...
  public void terminate(Graphics gra) {
    try {
      ...
      System.out.println(ie.getMessage());
      System.out.println("program ends without storing shapes because an IO exception occurred.");
    }
  }
